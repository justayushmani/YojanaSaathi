...
export const t = {
  English: {
    ...
    aboutIntro: "Welcome to Jan-Sahayak! This platform uses Artificial Intelligence to make Indian government services and legal documents radically accessible to everyone.",
  ...
  Hindi: {
    ...
    aboutIntro: "जन-सहायक में आपका स्वागत है! यह प्लेटफ़ॉर्म भारतीय सरकारी सेवाओं और कानूनी दस्तावेजों को सभी के लिए सुलभ बनाने के लिए आर्टिफिशियल इंटेलिजेंस (AI) का उपयोग करता है।",
  ...
  Hinglish: {
    ...
    aboutIntro: "Jan-Sahayak mein aapka swagat hai! Yeh platform Artificial Intelligence ka use karke Indian government services aur legal documents ko sabke liye accessible banata hai.",
